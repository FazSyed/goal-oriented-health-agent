...
def log_pipeline_run(patient_id, vitals: dict, ml_prediction: str, ontology_result: dict, planner_result: dict, routing_result: dict, timing_result: dict = None, sensor_timestamp: str=None):
